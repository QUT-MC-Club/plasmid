    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register(
            literal("game")
                ...
                .then(literal("join")
                    .requires(Permissions.require("plasmid.command.game.join", 0))
                ...
                .then(literal("spectate")
                     .requires(Permissions.require("plasmid.command.game.spectate", 0))
                ...
                .then(literal("locate")
                        .requires(Permissions.require("plasmid.command.game.locate", 0))
